...
class LogRepository:
    ...
    def start_run(self):
        ...
        algorithm_runs_collection.insert_one({"pid": self.pid, "start": datetime.now(timezone.utc), "status": "RUNNING"})
    ...
    def end_section(self, run_section: object):
        algorithm_runs_collection = self.__get_algorithm_runs_collection()
        algorithm_runs_collection.update_one(
            {"pid": self.pid},
    ...
    def set_section_status(self, run_section: object, status: object):
        algorithm_runs_collection = self.__get_algorithm_runs_collection()
        algorithm_runs_collection.update_one(
            {"pid": self.pid},
